...
//md: a helper function that returns an html audio object with the wav loaded as object url 
...
//md: # `f_o_file__wav__from_a_n_u8__after_header`: create a .wav file from a uint 8 array that contains audio data 
...
//md: # read (seconds length) or change the bitrate and other properties 
...
//md: # `a_n_u8__after_header`: is the audio data and can be updated 
...
//md: # `f_o_file__wav__from_a_n_u8`: create a wav file from a uint8 array that contains a full .wav file
